...
createCombinationDatabase (std::filesystem::path const &databasePath)
{
  ...
  gameLookup.insert ({ { uint8_t{2}, uint8_t{2} }, solveDurak (36, 2, 2, gameLookup) });
  std::cout << "solveDurak (36, 3, 1, gameLookup)" << std::endl;
  gameLookup.insert ({ { uint8_t{3}, uint8_t{1} }, solveDurak (36, 3, 1, gameLookup) });
  std::cout << "solveDurak (36, 2, 4, gameLookup)" << std::endl;
  gameLookup.insert ({ { uint8_t{2}, uint8_t{4} }, solveDurak (36, 2, 4, gameLookup) });
  std::cout << "solveDurak (36, 3, 3, gameLookup)" << std::endl;
  gameLookup.insert ({ { uint8_t{3}, uint8_t{3} }, solveDurak (36, 3, 3, gameLookup) });
