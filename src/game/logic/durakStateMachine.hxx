...
// , state<AskDef>                 + event<defendAnswerNo>                                   / handleDefendSuccess       //TODO                                                    = state<Chill>
, state<AskDef>                 + event<userRelogged>                                     / (userReloggedInAskDef)
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/      
// , state<AskAttackAndAssist>     + on_entry<_>                                             / startAskAttackAndAssist //TODO
// , state<AskAttackAndAssist>     + event<attackPass>                                       /(setAttackAnswer,checkAttackAndAssistAnswer) //TODO
// , state<AskAttackAndAssist>     + event<assistPass>                                       /(setAssistAnswer,checkAttackAndAssistAnswer) //TODO
...
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/      
// ,*"leaveGameHandler"_s          + event<leaveGame>                                        / userLeftGame                                //TODO
...
// , "timerHandler"_s              + event<pauseTimer>             [timerActive]             / (pauseTimerHandler) //TODO
// , "timerHandler"_s              + event<resumeTimer>            [timerActive]             / (resumeTimerHandler) //TODO
// , "timerHandler"_s              + event<sendTimerEv>            [timerActive]             / (sendTimer) //TODO
